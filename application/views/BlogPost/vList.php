        ...
        <div class='portlet light bordered'>
            ...
            <div class='portlet-body'>
                                    ...
                                    <div class="form-group form-horizontal filter">
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Judul Seo</label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control form-filter input-sm" name="judul_seo">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control form-filter input-sm" name="judul">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Blog Kategori</label>
                                                <div class="col-md-8">
                                                    <select name='blog_kategori_id' class='form-control form-filter select2-ajax' data-url='<?php echo site_url('form/dd/BlogKategoriModel') ?>'></select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6"> 
                ...
                <div class='table-container'>
                    ...
                    <table class="table table-bordered table-hover" id="tableBlogPost">
                        <thead>
...
<script type="text/javascript">
    ...
    datatableAjax.init({
        ...
        dataTable: {
            "ajax": {
                "url": "<?php echo site_url('BlogPost/getDatatable/') ?>"
            },
            "order": [
                [1, "asc"]
            ]

                                    ...
                                    <div class="form-group form-horizontal filter">
                                        ...
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                <?php 
                                                    $opt_act = ['' => 'Semua','1'=>'Aktif', '2'=>'Tidak Aktif'];
                                                    echo form_dropdown('active', $opt_act, '' ,'class="form-control form-filter select2-me"');
                                                    ?>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    datatableAjax.init({
        ...
        dataTable: {
            "ajax": {
                "url": "<?php echo site_url('Users/getDatatable/') ?>"
            },
            "order": [
                [1, "asc"]
            ],

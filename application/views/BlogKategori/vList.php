        ...
        <div class='portlet light bordered'>
            ...
            <div class='portlet-body'>
                                    ...
                                    <div class="form-group form-horizontal filter">
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                <label class="col-md-4 control-label">Kategori Seo</label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control form-filter input-sm" name="kategori_seo">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control form-filter input-sm" name="kategori">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                ...
                <div class='table-container'>
                    ...
                    <table class="table table-bordered table-hover" id="tableBlogKategori">
                        <thead>
...
<script type="text/javascript">
    ...
    datatableAjax.init({
        src: $("#tableBlogKategori"),
        dataTable: {
            "ajax": {
                "url": "<?php echo site_url('BlogKategori/getDatatable/') ?>"
            },
            "order": [
                [1, "asc"]
            ]

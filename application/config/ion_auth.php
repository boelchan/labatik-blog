 ...
 */
$config['site_title']                 = "Labatik ID";       // Site Title, example.com
$config['admin_email']                = "admin@labatik.id"; // Admin Email, admin@example.com
$config['default_group']              = '10';           // Default group, use name
...
$config['user_expire']                = 259200;               // How long to remember the user (seconds). Set to zero for no expiration - see sess_expiration in CodeIgniter Session Config for session expiration
...
/*
 ...
 | Please customize
 */
$config['session_hash'] = '658asd3d6c4f2ad05asd998egeadsrc4a532csfdc345adsasd39f225$##%^1@@$$44$4ea0006';
 ...
 */
$config['remember_cookie_name'] = 'blog_labatik_remember_code';

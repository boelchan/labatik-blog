    ...
    $string .= "
                            <div class='col-md-6'>
                                <div class='form-group'>
                                    ...
                                    <div class='col-md-9'>
                                        <textarea class=\"form-control\" rows=\"3\" name=\"" . $row["column_name"] . "\" id=\"" . $row["column_name"] . "\" placeholder=\"" . label($row["column_name"]) . "\"><?php echo \$row->".$row["column_name"]." ?></textarea>
                                    </div>
                                    </div>
                            </div>
                            ";
                                    ...
                                    <div class='col-md-9'>
                                        <?php
                                            ...
                                            if (!empty($".$row["column_name"]."))
                                                \$".$row["column_name"]."_name = \$this->".lcfirst($row["r_model"])."->get($" . $row["column_name"] . ")->{".$row["r_label"]."};
                                        ?>
                                        <select name='".$row["column_name"]."' class='form-control select2-ajax' data-url='<?php echo site_url('form/dd/".lcfirst($row["r_model"])."') ?>'>
                                ...
                                <div class='form-group'>
                                    ...
                                    <div class='col-md-9'>
                                        <div class='input-group date ".$class_date."' >
                                            ...
                                            <input type='text' class='form-control ' readonly name=\"" . $row["column_name"] . "\" value=\"<?php echo id_date(\$row->".$row["column_name"].") ?>\">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    $string .= "
                            <div class='col-md-6'>
                                <div class='form-group'>
                                    <label class='col-md-3 control-label'>". label($row["f_name"]) . $bintang . "</label>
                                    <div class='col-md-9'>
                                        <input type=\"text\" class=\"form-control mask-number\" name=\"" . $row["column_name"] . "\" id=\"" . $row["column_name"] . "\" placeholder=\"" . label($row["column_name"]) . "\" value=\"<?php echo \$row->".$row["column_name"]." ?>\" />
                                    </div>
                                </div>
                            </div>
                            ";
    ...
    $string2 .= "
                            <div class='col-md-6'>
                                <div class='form-group'>
                                    <label class='col-md-3 control-label'> ". label($row["f_name"]) . $bintang . "</label>
                                    <div class='col-md-9'>
                                        <?php \$".$row["column_name"]." = \$row->".$row["column_name"]." ?>
    ...
    $string .= "
                            <div class='col-md-6'>
                                <div class='form-group'>
                                    <label class='col-md-3 control-label'>". label($row["f_name"]) . $bintang . "</label>
                                    <div class='col-md-9'>
                                        <input type=\"text\" class=\"form-control\" name=\"" . $row["column_name"] . "\" id=\"" . $row["column_name"] . "\" placeholder=\"" . label($row["column_name"]) . "\" value=\"<?php echo \$row->".$row["column_name"]." ?>\" />
                                    </div>
                                </div>
                            </div>
                            ";
...
$hasil_view_edit = createFile($string, $target_view . $v_edit_file);
?>

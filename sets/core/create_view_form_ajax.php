<?php $string = " <section class='content'>
    <div class='row'>
        <div class='col-md-12'>
            <div class='portlet light'>
                <div class='portlet-title'>
                    <div class='caption'>
                        <?php echo btnBack() ?>
                        <span class='caption-subject bold '><?php echo (isset(\$row)) ? 'Edit' : 'Tambah'; ?> Data </span>
                    </div>
                </div>
    ...
    $string .= "
                                <div class='col-md-6'>
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-9'>
                                            <textarea class=\"form-control\" rows=\"3\" name=\"" . $row["column_name"] . "\" id=\"" . $row["column_name"] . "\" placeholder=\"" . label($row["column_name"]) . "\"><?php echo (isset(\$row)) ? \$row->".$row["column_name"]." : ''; ?></textarea>
                                        </div>
                                      </div>
                                </div>
                                ";
    ...
    $string .= "
                                <div class='col-md-6'>
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-9'>
                                            <?php
                                            \$".$row["column_name"]." = (isset(\$row)) ? \$row->".$row["column_name"]." : '';
                                            if (!empty($".$row["column_name"].")) {
                                                \$".$row["column_name"]."_name = \$this->".strtolower($row["r_model"])."->get($" . $row["column_name"] . ")->{".strtolower($row["r_label"])."};
                                            }else{
                                                \$".$row["column_name"]."_name = '';
                                            }
                                            ?>
                                            <select name='".$row["column_name"]."' class='form-control select2-ajax' data-url='<?php echo site_url('form/dd/".strtolower($row["r_model"])."') ?>'>
                                                <option value=\"<?php echo \$".$row["column_name"]."; ?>\" selected=\"selected\"><?php echo \$".$row["column_name"]."_name; ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-md-9'>
                                            <div class='input-group date ".$class_date."' >
                                                ...
                                                <input type='text' class='form-control ' readonly name=\"" . $row["column_name"] . "\" value=\"<?php echo (isset(\$row)) ? \$row->".$row["column_name"]." : ''; ?>\">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class='col-md-9'>
                                            ...
                                            <div class=\"fileinput fileinput-new\" data-provides=\"fileinput\">
                                                <div class=\"fileinput-preview thumbnail\" data-trigger=\"fileinput\" style=\"width: 200px; height: 150px;\">
                                                    <img src=\"<?php echo load_image(\"".$table_name."_".strtolower(label($row["f_name"]))."/\".\$".$row["column_name"]. ", \"thumb\") ?>\" alt=\"\">
                                                </div>
                                                <div>
    ...
    $string .= "
                                <div class='col-md-6'>
                                    <div class='form-group'>
                                        <label class='col-md-3 control-label'>". label($row["f_name"]) . $bintang . "</label>
                                        <div class='col-md-9'>
                                            <input type=\"text\" class=\"form-control\" name=\"" . $row["column_name"] . "\" id=\"" . $row["column_name"] . "\" placeholder=\"" . label($row["column_name"]) . "\" value=\"<?php echo (isset(\$row)) ? \$row->".$row["column_name"]." : ''; ?>\" />
                                        </div>
                                    </div>
                                </div>
                                ";
                        ...
                        <div class='form-actions'>
                            <div class='row'>
                                <div class='col-md-offset-5 col-md-7'>
                                    <button type='submit' class='btn green btn-circle' name='mode' value='new' > <?php echo (isset(\$row)) ? 'Edit' : 'Tambah'; ?> Data  </button>
                                </div>
                            </div>
                        </div>
                          ";

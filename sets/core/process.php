...
if (isset($_POST['generate']))
{
    ...
    if ($table_name <> '')
    {
        ...
        include 'core/create_view_create_ajax.php';
        include 'core/create_view_edit_ajax.php';

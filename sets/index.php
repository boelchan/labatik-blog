    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            function setname() {
                ...
                if (table_name != '') {
                    var nameSplit = table_name.split('_');
                    var newName = []
                    $.each(nameSplit, function (indexInArray, valueOfElement) { 
                         newName.push(capitalize(valueOfElement))
                    });
                    a = newName.join('')
                    document.getElementById('controller').value = a;

...
var Datatable = function() {
    ...
    var countSelectedRecords = function() {
        ...
        if (selected > 0) {
            $('.table-group-actions > span', tableWrapper).text(text.replace("TOTAL", selected));
        } else {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    ...
                    "language": { // language settings
                        // metronic spesific
                        "metronicGroupActions": "TOTAL records selected:  ",
                        "metronicAjaxRequestGeneralError": "Could not complete request. Please check your internet connection",

                        // data tables spesific
                        "lengthMenu": "<span class='seperator'>|</span>View MENU records",
                        "info": "<span class='seperator'>|</span>Found total TOTAL records",

        ...
        try {
            ...
            while (fContinue) {
                ...
                if (cmd.equalsIgnoreCase("DONE")) {
                    ...
                    // Command Format: REPGEN:JASPERBASE:TARGET:PARAMS
                    // TARGET: PDF-FILE, PDF-STREAM, HTML-FILE, HTML-STREAM
                    ...
                    if(st.countTokens()>=4) { 
                        ...
                        if(iJasperTarget!=ReportGenerator.FORMAT_UNKNOWN) {
                            ...
                            if(!jasperTarget.endsWith("STREAM")) {
                                ...
                                byte[] res = repGen.run(jasperBase, iJasperTarget, jasperParams, outFileName);
                                ...
                                byte[] resBytes = repGen.run(jasperBase, iJasperTarget, jasperParams, outFileName);
